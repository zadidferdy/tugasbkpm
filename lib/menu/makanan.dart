...
class Makanan extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: OrderMakananPage(),
    );
  }
}

class OrderMakananPage extends StatefulWidget {
  @override
  _OrderMakananPageState createState() => _OrderMakananPageState();
}

class _OrderMakananPageState extends State<OrderMakananPage> {
  ...
  void _pesanMakanan() {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text('Terima kasih $nama!\nAnda memesan $_jumlah porsi makanan.'),
        actions: [
          TextButton(
            child: Text('OK'),
        ...
        child: Card(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Image.network(
                  'https://cdn-icons-png.flaticon.com/512/2718/2718224.png', // ikon makanan
                  height: 100,
                ),
                SizedBox(height: 20),
